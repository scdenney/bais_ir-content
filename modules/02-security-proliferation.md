---
layout: module
title: "Security Dilemmas & Nuclear Proliferation"
module: 2
subtitle: "Why States Build the Bomb"
accent: "#B8593E"
themes: ["Deterrence", "Proliferation", "Waltz–Sagan Debate", "Framing Experiment"]
syllabus_weeks: "Week 3"
prev_module: "/modules/01-ir-theories"
prev_title: "Module 1: IR Theories"
next_module: "/modules/03-nonwestern-ir"
next_title: "Module 3: Non-Western IR"
---
...
- **Security model:** North Korea faces a genuine existential security threat. It confronts the U.S. military presence in South Korea, joint U.S.-ROK military exercises, and regime-change rhetoric from Washington. From Pyongyang's perspective, nuclear weapons are the ultimate insurance policy against invasion.
...
- **Norms model:** Nuclear weapons are central to North Korean identity and regime legitimacy. The DPRK's constitution was amended to enshrine its nuclear status. The program is framed domestically as the crowning achievement of *juche* (self-reliance) — a demonstration that a small, isolated state can stand against the world's most powerful military.

- **Bargaining leverage:** Beyond Sagan's original three models, North Korea has also used its nuclear program as a bargaining chip — leveraging it for diplomatic attention, economic concessions, and sanctions relief. The program's value extends beyond security into diplomacy and regime maintenance.
...
- Andrew Heywood and Ben Whitham, *Global Politics* (3rd ed., Chapter 12: The global politics of weapons of mass destruction). London: Red Globe Press, 2023.
...
<details>
<summary><strong>The Waltz–Sagan Debate</strong></summary>

- Kenneth N. Waltz, "The Spread of Nuclear Weapons: More May Be Better," *Adelphi Papers*, no. 171. London: IISS, 1981.
...
<details>
<summary><strong>Beyond Sagan</strong></summary>
...
- Etel Solingen, *Nuclear Logics: Contrasting Paths in East Asia and the Middle East*. Princeton, NJ: Princeton University Press, 2007.
- Jeannie L. Johnson, Kerry M. Kartchner, and Jeffrey A. Larsen (eds.), *Strategic Culture and Weapons of Mass Destruction*. New York: Palgrave Macmillan, 2009.

</details>

<details>
<summary><strong>Recommended Readings</strong></summary>

- Sheena Chestnut Greitens, "Proliferation of Weapons of Mass Destruction," in Baylis, Smith, and Owens (eds.), *The Globalization of World Politics* (9th ed., Chapter 30). Oxford: OUP, 2022.
- Sang-Hun Choe, "North Korea's Arsenal Has Grown Rapidly. Here's What's in It," *The New York Times*, October 1, 2021.
- Heather Williams, "Why Is Russia Changing Its Nuclear Doctrine Now," *Center for Strategic and International Studies*, September 27, 2024.
...
- Arms Control Association — nuclear arsenal estimates and arms control fact sheets
- Stockholm International Peace Research Institute (SIPRI) — global nuclear warhead inventories
