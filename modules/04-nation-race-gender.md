---
layout: module
title: "Nation, Race, and Gender"
module: 4
subtitle: "Constructing Belonging, Drawing Boundaries"
accent: "#C9A2A0"
themes: ["Nationalism", "Race & Ethnicity", "Gender", "Identity Politics"]
...
- **Nation:** A community of people bound by shared culture, history, identity, and a sense of belonging to a common political project. It has cultural, political, and psychological dimensions — common language, religion, traditions, a sense of being a "natural" political community, and feelings of loyalty or patriotism.

- **State:** A sovereign political entity defined by government, territory, and population. States exercise a monopoly on the legitimate use of force within their borders.

- **Nation-state:** The idealized alignment of nation and state — an autonomous political community of one predominant nation. In practice, most states are multinational or multiethnic, but nationalism asserts that each nation should have its own state.
...
<details>
<summary>Required and Recommended Readings</summary>
<div>

**Required (from syllabus):**
- Nagel, J. (2022). "Masculinity and Nationalism." In G. Herb & D. Kaplan (Eds.), *Scaling Identities: Nationalism and Territoriality*. Rowman & Littlefield.
- Heywood, A., & Whitham, B. (2023). *Global Politics*, 3rd ed., Chs. 8–9 ("Nations and Nationalism" and "Race and Ethnicity"). Bloomsbury Academic.
- Griffiths, M., & Sullivan, M. (1997). "Nationalism and International Relations Theory." *Australian Journal of Politics and History*, 43(1), 53–63.

**Recommended:**
- Ko, J. (2023). *Popular Nationalism and War*. Cambridge University Press.
- Smith, A. D. (2010). *Nationalism: Theory, Ideology, History*, 2nd ed. Polity.
- Hutchinson, J. (2017). *Nationalism and War*. Oxford University Press.
- Anderson, B. (1983). *Imagined Communities: Reflections on the Origin and Spread of Nationalism*. Verso.
- Mylonas, H., & Tudor, M. (2023). *Varieties of Nationalism: Communities, Narratives, Identities*. Cambridge University Press.
